...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    @Override
    public BankAccountDTO getClientBankAccount(String accountId, Long clientId) throws BankAccountNotFoundException, ClientNotFoundException {
        Client client = clientRepository.findById(clientId)
                .orElseThrow(() -> new ClientNotFoundException("Client Not found"));
        BankAccount bankAccount = bankAccountRepository.findByIdAndClient_Id(accountId, client.getId())
                .orElseThrow(() -> new BankAccountNotFoundException("BankAccount not found"));
        if (bankAccount instanceof SavingAccount savingAccount) {
            return dtoMapper.fromSavingBankAccount(savingAccount);
        } else {
    ...
    @Override
    public List<BankAccountDTO> bankAccountClientList(Long clientId) throws ClientNotFoundException {
        Client client = clientRepository.findById(clientId)
                .orElseThrow(() -> new ClientNotFoundException("Client Not found"));
        List<BankAccount> bankAccounts = bankAccountRepository.findByClient_Id(client.getId());
    ...
    @Override
    public AccountHistoryDTO getClientAccountHistory(String accountId, Long clientId, int page, int size) throws BankAccountNotFoundException, ClientNotFoundException {
        Client client = clientRepository.findById(clientId)
                .orElseThrow(() -> new ClientNotFoundException("Client Not found"));
        BankAccount bankAccount = bankAccountRepository.findByIdAndClient_Id(accountId,client.getId()).orElse(null);
        if (bankAccount == null) {
